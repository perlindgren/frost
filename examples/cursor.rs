...
//! and `assets/sprites/water_can.png` follows the pointer: the sprite is
//! cropped to the can, so the demo scales it to `CAN_SIZE` pixels wide
//! and its node — the texture's center — lands on the cursor. The
